        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('teacher.courses.materials.store', $course) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mt-4">
                            <x-input-label for="file" :value="__('Material File (Optional)')" />
